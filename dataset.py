...
def _process_sample(php_code, label):
    """
...
def get_dataset(dataset_path):
    ...
    with open(dataset_path, "r") as f:
        for line in f:
            ...
            dataset.append(_process_sample(json_object['func'], json_object['target']))

    if len(dataset) == 0:
        raise Exception(f"No valid JSON samples found in '{dataset_path}'")
